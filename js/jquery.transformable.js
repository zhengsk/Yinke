...
$(document).ready(function() {
	...
	var originMovesWithPadding=true;
	{
		...
		$('body').append('<div id="transformableeraseme" style="overflow: hidden; position: absolute; border-style: solid; border-width: 1px; border-color: rgb(0, 0, 0); left: -1000px; top: -1000px; width: 250px; height: 250px;">\
			<div id="transformableeraseme2" class="mashbox" style="border-width: 1px; border-color: black; border-style: solid; left: 10px; top: 10px; width: 20px; height: 20px;"></div>\
		</div>');
		...
		//console.log(torigin+'=='+tmp.css(vpref+'transform-origin'));
...
//console.log("originusesborder="+originusesborder);
	...
	function enablescale(tf) {
		...
		//moved to upper left, - forget double click thing
			tf.append('<div class="transformable-handle-scale transformable-handle ui-icon ui-icon-search" title="调整图片大小" style="left: 1px; top: 1px; position: absolute; z-index: 2000;"></div>');
...
*/
	...
	function enableskew(tf) {
		...
		tf.append('<div title="X-斜线" class="transformable-handle-skew-h transformable-handle-skew transformable-handle ui-icon ui-icon-arrow-2-e-w" style="left: 50%; top: 1px; position: absolute; z-index: 2000;"></div>');
		tf.append('<div title="Y-斜线"class="transformable-handle-skew-v transformable-handle-skew transformable-handle ui-icon ui-icon-arrow-2-n-s" style="right: 1px; top: 50%; position: absolute; z-index: 2000;"></div>');
	...
	function enablerotate(tf) {
		tf.append('<div title="旋转" class="transformable-handle-rotate transformable-handle ui-icon ui-icon-arrowrefresh-1-s" style="right: 1px; top: 1px; position: absolute; z-index: 2000;"></div>');
...
//console.log(event);
	...
	$.fn.tDragStart=function (x,y,skipuntransformed){
	   var self=this;
